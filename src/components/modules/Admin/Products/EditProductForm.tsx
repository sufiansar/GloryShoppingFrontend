...
export default function EditProductForm({ product }: EditProductFormProps) {
 ...
 className="rounded-xl h-8 text-[9px] font-medium text-primary-custom hover:bg-primary-custom/10"
 >
 Change
 </Button>
 )}
 ...
 <h3 className="font-medium text-slate-900 dark:text-white truncate">{selectedBrand.name}</h3>
 ...
 <span className="text-sm font-medium text-slate-500">Select Brand</span>
 </div>
 </Button>
 )}
 </div>
 ...
 <div className="flex-1 truncate">
 <h3 className="font-medium text-slate-900 dark:text-white truncate">{selectedCategory.name}</h3>
 <p className="text-sm font-bold text-slate-400 truncate">
 ...
 <div className="flex flex-col items-center gap-2">
 <Plus className="h-5 w-5 text-slate-400 group-hover:text-primary-custom transition-colors"/>
 <span className="text-sm font-medium text-slate-500">Select Category</span>
 </div>
 </Button>
 )}
 </div>
 ...
 <div>
 <h2 className="text-xl font-medium text-slate-900 dark:text-white">Additional Information</h2>
 </div>
 </div>
 ...
 <div className="space-y-2">
 <Label htmlFor="price"className="text-sm font-medium text-slate-400 ml-1">Price ($) *</Label>
 <div className="relative group/input">
 ...
 placeholder="0.00"
 required
 className="h-14 pl-11 bg-white/60 dark:bg-slate-800/40 backdrop-blur-md border-primary/40 dark:border-primary/40 rounded-2xl shadow-inner focus-visible:ring-emerald-500/30 text-lg font-medium transition-all duration-300"
 />
 </div>
 </div>
 ...
 <p className="text-[13px] font-medium text-slate-600 dark:text-slate-300 mb-1 group-hover:text-primary-custom transition-colors">Click to Browse or Drag Image Here</p>
 <p className="text-sm font-bold text-slate-400 opacity-80 er">Supports JPG, PNG, WEBP (Maximum 5MB)</p>
 </div>
 </div>
 </div>
 )}
 ...
 {[
 { id:"isNew", label:"Mark as New", color:"data-[state=checked]:!bg-blue-500", activeBg:"bg-blue-50/60 border-blue-200/60 dark:bg-blue-500/10 dark:border-blue-500/30"},
 { id:"isFeatured", label:"Mark as Featured", color:"data-[state=checked]:!bg-amber-500", activeBg:"bg-amber-50/60 border-amber-200/60 dark:bg-amber-500/10 dark:border-amber-500/30"},
 { id:"isTrending", label:"Mark as Trending", color:"data-[state=checked]:!bg-violet-500", activeBg:"bg-violet-50/60 border-violet-200/60 dark:bg-violet-500/10 dark:border-violet-500/30"},
 { id:"isBestSeller", label:"Mark as Best Seller", color:"data-[state=checked]:!bg-rose-500", activeBg:"bg-rose-50/60 border-rose-200/60 dark:bg-rose-500/10 dark:border-rose-500/30"},
 { id:"isStock", label:"Mark as In Stock", color:"data-[state=checked]:!bg-emerald-500", activeBg:"bg-emerald-50/60 border-emerald-200/60 dark:bg-emerald-500/10 dark:border-emerald-500/30"},
 ].map((flag) => {
 ...
 className="data-[state=checked]:!bg-primary-custom data-[state=unchecked]:bg-slate-300 dark:data-[state=unchecked]:bg-slate-600"
 />
 </div>
 </div>
 </div>
 ...
 {/* Global Action Bar */}
 <div className="mt-8 pt-8 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-6">
 <Button
 type="button"
 variant="ghost"
 size="lg"
 ...
 className="rounded-2xl h-14 px-8 text-sm font-medium text-slate-400 hover:text-slate-900 dark:hover:text-white bg-slate-50 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 transition-all active:scale-95"
 >
 Cancel
 </Button>
 ...
 className="rounded-2xl h-14 flex-1 w-full px-10 bg-primary-custom text-white font-medium text-sm shadow-xl shadow-primary-custom/20 hover:shadow-primary-custom/40 transition-all active:scale-[0.98] disabled:opacity-50 border-none"
 >
