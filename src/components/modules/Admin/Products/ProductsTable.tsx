...
"isActive",
 ...
 <TableHead className="w-24 py-6 pl-8 text-sm font-medium text-slate-400">Image</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Name</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">SKU</TableHead>
 ...
 <TableHead className="py-6 text-sm font-medium text-slate-400">Category</TableHead>
 ...
 <span className="text-sm font-medium text-slate-900 dark:text-white line-clamp-1 group-hover/row:text-primary-custom transition-colors">
 {product.name}
 </span>
 <div className="flex flex-wrap gap-1.5">
 {product.isNew && (
 <span className="px-2 py-0.5 rounded-md bg-blue-500/10 text-blue-500 text-[9px] font-medium tracking-wider border border-blue-500/20">
 New
 </span>
 )}
 {product.isFeatured && (
 <span className="px-2 py-0.5 rounded-md bg-amber-500/10 text-amber-500 text-[9px] font-medium tracking-wider border border-amber-500/20 flex items-center gap-1">
 <Star className="h-2 w-2 fill-amber-500"/> Featured
 </span>
 )}
 {product.isTrending && (
 <span className="px-2 py-0.5 rounded-md bg-pink-500/10 text-pink-500 text-[9px] font-medium tracking-wider border border-pink-500/20 flex items-center gap-1">
 <TrendingUp className="h-2 w-2"/> Trending
 </span>
 )}
 {product.isStock && (
 <span className="px-2 py-0.5 rounded-md bg-emerald-500/10 text-emerald-500 text-[9px] font-medium tracking-wider border border-emerald-500/20 flex items-center gap-1">
 ...
 {product.stock || 0}
 <span className="text-sm font-bold text-slate-400 ml-1">Units</span>
 </span>
 </div>
 ...
 <span className="text-lg font-medium text-slate-900 dark:text-white er">
 ${product.price?.toFixed(2) ||"0.00"}
 </span>
 {product.discount && product.discount > 0 && (
 <span className="text-sm font-medium text-rose-500 er line-through opacity-70">
 ...
 <TableCell>
 <div className="flex flex-col gap-1">
 <code className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded font-mono text-sm text-primary-custom w-fit">
