...
export default function ProductDetails({ product }: ProductDetailsProps) {
 ...
 {product.isNew && (
 <span className="bg-primary-custom/10 text-primary-custom px-3 py-1.5 rounded-full border border-primary-custom/20 text-sm font-medium">
 New
 </span>
 )}
 ...
 <span className="text-sm font-medium text-primary-custom bg-primary-custom/10 px-3 py-1 rounded-xl">
 {product.slug ||"N/A"}
 </span>
 </div>
 </div>
 ...
 <span className="flex items-center gap-1 text-[9px] font-medium text-rose-500 bg-rose-500/10 px-2 py-1 rounded-lg">
 <Percent className="h-3 w-3"/> {product.discount}% OFF
 </span>
 )}
 </div>
 <div className="flex items-baseline gap-3">
 <span className="text-3xl font-medium text-emerald-600 dark:text-emerald-400">
 ...
 <div>
 <span className={clsx(
"text-xl font-medium px-4 py-1.5 rounded-xl border",
 product.stock === 0
 ...
 <h2 className="text-sm font-medium text-slate-900 dark:text-white">Short Description</h2>
 </div>
 ...
 <h2 className="text-sm font-medium text-slate-900 dark:text-white">Full Details</h2>
 </div>
 ...
 <h2 className="text-sm font-medium text-slate-900 dark:text-white">FAQ & Questions</h2>
 </div>
 <div className="p-8 bg-white/50 dark:bg-slate-800/50 rounded-[2rem] border border-white/40">
 <div className="prose prose-slate dark:prose-invert max-w-none text-sm font-medium">
 <p className="whitespace-pre-wrap text-slate-700 dark:text-slate-300 leading-relaxed">
