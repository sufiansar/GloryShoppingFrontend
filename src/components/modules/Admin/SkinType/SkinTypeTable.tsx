...
export default function SkinTypeTable() {
 ...
 <TableHead className="py-4 pl-8 text-xs font-semibold text-slate-500 tracking-wider">Profile Name</TableHead>
 <TableHead className="py-4 text-xs font-semibold text-slate-500 tracking-wider">Data Description</TableHead>
 <TableHead className="py-4 text-xs font-semibold text-slate-500 tracking-wider">Registration Date</TableHead>
 <TableHead className="text-right py-4 pr-8 text-xs font-semibold text-slate-500 tracking-wider">Operations</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {loading ? (
 ...
 <DropdownMenuLabel className="text-sm font-medium text-slate-400 px-3 py-2">Classification Tools</DropdownMenuLabel>
 ...
 <span className="text-sm font-medium tracking-[0.3em] text-rose-500">System Alert: Purge Sequence</span>
