          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-slate-200/30 dark:border-slate-800/30 hover:bg-transparent">
                <TableHead className="py-4 pl-8 text-xs font-semibold text-slate-500 uppercase tracking-wider">Target Concern</TableHead>
                <TableHead className="py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Clinical Description</TableHead>
                <TableHead className="py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Created</TableHead>
                <TableHead className="text-right py-4 pr-8 text-xs font-semibold text-slate-500 uppercase tracking-wider">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
                    ...
                    <TableCell className="text-right pr-10">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-56 p-2 rounded-2xl border-white/20 dark:border-slate-800/50 backdrop-blur-3xl glass-card">
                          <DropdownMenuLabel className="text-[10px] font-black uppercase tracking-widest text-slate-400 px-3 py-2">Matrix Context</DropdownMenuLabel>
        ...
        <AlertDialogContent className="max-w-md p-0 overflow-hidden premium-glass-dialog border-none rounded-[3rem]">
          <div className="p-10 flex flex-col items-center text-center gap-8">
             ...
             <div className="space-y-2">
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-500">Clinical Alert: Purge Sequence</span>
