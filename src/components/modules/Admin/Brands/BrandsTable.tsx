...
"view",
 ...
 <TableHead className="w-24 py-6 pl-8 text-sm font-medium text-slate-400">Logo</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Name</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Slug</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Country</TableHead>
 ...
 <span className="text-sm font-medium text-slate-300 leading-none">ID</span>
 </div>
 )}
 </div>
 </TableCell>
 ...
 <TableCell>
 {brand.country ? (
 <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary-custom/5 text-primary-custom rounded-full text-sm font-medium border border-primary-custom/10">
 {brand.country}
 </div>
 ) : (
