...
const OrderDetailsDialog: React.FC<OrderDetailsDialogProps> = ({
 ...
 <span className="text-sm font-medium tracking-[0.3em] text-primary-custom">Order Access</span>
 </div>
 <DialogTitle className="text-3xl font-medium text-slate-900 dark:text-white leading-none">
 ...
 <Badge className={`h-12 px-6 rounded-2xl text-sm font-medium border ${getStatusColor(order.status)} shrink-0 shadow-sm`}>
 {order.status}
 </Badge>
 </div>
 </DialogHeader>
 ...
 <h3 className="text-[11px] font-medium text-slate-500">Customer Information</h3>
 </div>
 {(() => {
 ...
 <p className="text-[9px] font-medium text-slate-400 mb-1">Name</p>
 <p className="font-medium text-slate-900 dark:text-white leading-none">{delivery?.name ||"N/A"}</p>
 </div>
 <div className="p-4 rounded-2xl bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-slate-800/50">
 <p className="text-[9px] font-medium text-slate-400 mb-1">Email</p>
 <p className="font-bold text-slate-600 dark:text-slate-300 truncate">{delivery?.email ||"N/A"}</p>
 </div>
 <div className="p-4 rounded-2xl bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-slate-800/50">
 <p className="text-[9px] font-medium text-slate-400 mb-1">Phone</p>
 ...
 <h3 className="text-[11px] font-medium text-slate-500">Shipping Information</h3>
 </div>
 {(() => {
 const delivery = (order as any).delivery || order.deliveryDetails || {};
 return (
 <div className="space-y-5">
 <div className="p-4 rounded-2xl bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-slate-800/50">
 <p className="text-[9px] font-medium text-slate-400 mb-1">Address</p>
 ...
 <div className="p-4 rounded-2xl bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-slate-800/50">
 <p className="text-[9px] font-medium text-slate-400 mb-1">City</p>
 <p className="font-medium text-slate-900 dark:text-white">{delivery?.city ||"N/A"}</p>
 </div>
 <div className="p-4 rounded-2xl bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-slate-800/50">
 <p className="text-[9px] font-medium text-slate-400 mb-1">Postal Code</p>
 <p className="font-medium font-mono text-slate-900 dark:text-white">{delivery?.postalCode ||"N/A"}</p>
 </div>
 </div>
 </div>
 );
 ...
 <h3 className="text-[11px] font-medium text-slate-500">Order Items</h3>
 </div>
 ...
 <th className="text-left p-5 text-[9px] font-medium text-slate-400">Product</th>
 <th className="text-center p-5 text-[9px] font-medium text-slate-400">Quantity</th>
 <th className="text-right p-5 text-[9px] font-medium text-slate-400">Price</th>
 <th className="text-right p-5 text-[9px] font-medium text-slate-400">Total</th>
 </tr>
 </thead>
 ...
 <td className="p-5">
 <div>
 <p className="font-medium text-slate-900 dark:text-white leading-none mb-1 group-hover/row:text-primary-custom transition-colors">
 ...
 <span className="inline-flex items-center justify-center h-8 w-12 bg-slate-100 dark:bg-slate-800 rounded-lg text-xs font-medium text-slate-700 dark:text-slate-300 group-hover:bg-white transition-colors">{item.quantity}</span>
 </td>
 <td className="p-5 text-right font-bold text-slate-600 dark:text-slate-400 text-xs">{formatCurrency(item.price)}</td>
 <td className="p-5 text-right">
 <span className="text-sm font-medium text-slate-900 dark:text-white">{formatCurrency(item.price * item.quantity)}</span>
 </td>
 </tr>
 ))}
 </tbody>
 ...
 <h3 className="text-[11px] font-medium text-slate-500">Order Summary</h3>
 </div>
 ...
 <span className="text-[11px] font-medium text-slate-900 dark:text-white">Total Amount</span>
 <span className="text-2xl font-medium text-emerald-500">
 ...
 <h3 className="text-[11px] font-medium text-slate-500">Order Timeline</h3>
 </div>
 ...
 <div className="space-y-1">
 <p className="text-[11px] font-medium text-slate-900 dark:text-white">Order Placed</p>
 ...
 variant="outline"
 onClick={onClose}
 className="flex-1 h-16 rounded-[1.5rem] border-slate-200 dark:border-slate-800 font-medium text-sm hover:bg-slate-100 dark:hover:bg-slate-800 transition-all active:scale-[0.98] shadow-sm"
 >
 Close
 </Button>
 ...
 className="flex-[1.5] h-16 rounded-[1.5rem] bg-primary-custom text-white font-medium text-sm hover:shadow-primary-custom/40 transition-all shadow-xl shadow-primary-custom/10 active:scale-[0.98] border-none"
 >
 Update Status
 </Button>
 )}
