...
const AdminOrdersDashboard = () => {
 ...
 <SelectTrigger className="h-14 bg-white/60 dark:bg-slate-800/40 backdrop-blur-md border-primary/40 dark:border-primary/40 rounded-2xl shadow-inner focus:ring-primary-custom/30 font-bold transition-all duration-300 text-sm">
 <SelectValue placeholder="Filter by status"/>
 </SelectTrigger>
 <SelectContent className="rounded-2xl border-white/20 dark:border-slate-800/50 backdrop-blur-2xl">
 <SelectItem value="all"className="rounded-xl font-bold text-sm">All Status</SelectItem>
 <SelectItem value="PENDING"className="rounded-xl font-bold text-sm text-amber-500">Pending</SelectItem>
 <SelectItem value="PROCESSING"className="rounded-xl font-bold text-sm text-blue-500">Processing</SelectItem>
 <SelectItem value="SHIPPED"className="rounded-xl font-bold text-sm text-purple-500">Shipped</SelectItem>
 <SelectItem value="DELIVERED"className="rounded-xl font-bold text-sm text-green-500">Delivered</SelectItem>
 <SelectItem value="CANCELLED"className="rounded-xl font-bold text-sm text-rose-500">Cancelled</SelectItem>
 </SelectContent>
 </Select>
 ...
 className="flex-1 rounded-2xl h-full bg-primary-custom text-white font-medium text-sm shadow-lg shadow-primary-custom/20 hover:shadow-primary-custom/40 transition-all border-none"
 >
 ...
 className="rounded-2xl h-full px-6 border-rose-500/20 bg-rose-500/10 hover:bg-rose-500/20 text-sm font-medium text-rose-500 transition-all"
 >
 Clear
 </Button>
 </div>
 ...
 <TableHead className="py-6 pl-8 text-sm font-medium text-slate-400">Order ID</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Customer</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Date</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Amount</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Status</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Items</TableHead>
 ...
 <span className="text-sm font-medium text-slate-400">No Orders Found</span>
 </div>
 </TableCell>
 </TableRow>
 ) : (
 ...
 <span className="text-xs font-medium text-primary-custom bg-primary-custom/5 px-2 py-1 rounded-lg border border-primary-custom/10 w-fit">
 ...
 <TableCell>
 <span className="text-sm font-medium text-slate-900 dark:text-white er">
 ...
 <TableCell>
 <div className="inline-flex items-center gap-1.5 px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded font-bold text-sm text-slate-500 border border-slate-200/50">
