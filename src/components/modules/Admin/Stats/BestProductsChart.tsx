      ...
      {products.length === 0 ? (
        ...
        products.map((product, index) => (
          <div key={index} className="flex items-center gap-4">
            <div className="relative w-12 h-12 rounded-lg overflow-hidden bg-linear-to-br from-blue-50 to-blue-100 flex items-center justify-center shrink-0">
              <img
                src={`https://via.placeholder.com/48x48/4f46e5/ffffff?text=${product.name?.charAt(0)}`}
