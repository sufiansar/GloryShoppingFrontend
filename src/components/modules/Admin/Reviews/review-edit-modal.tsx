        ...
        <div className="p-10 space-y-8">
          <DialogHeader className="space-y-1">
            <div className="flex items-center gap-2 mb-2">
               ...
               <span className="text-[10px] font-black uppercase tracking-[0.3em] text-amber-500">Record Modification</span>
            </div>
            <DialogTitle className="text-3xl font-black uppercase tracking-tight text-slate-900 dark:text-white">Edit Review</DialogTitle>
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                 <Input
                  ...
                  className="h-16 pl-10 bg-white/60 dark:bg-slate-800/40 backdrop-blur-md border-primary/40 dark:border-primary/40 rounded-2xl shadow-inner focus-visible:ring-amber-500/30 text-xl font-black text-slate-900 dark:text-white transition-all duration-500"
                />
          ...
          <div className="flex gap-4">
            <Button 
              ...
              onClick={onClose} 
              disabled={loading}
              className="flex-1 h-16 rounded-[1.5rem] border-slate-200 dark:border-slate-800 font-black uppercase tracking-[0.2em] text-[10px] hover:bg-slate-100 dark:hover:bg-slate-800 transition-all active:scale-[0.98]"
            >
              Cancel Operation
            </Button>
            <Button 
              onClick={handleSave} 
              disabled={loading}
              className="flex-[1.5] h-16 rounded-[1.5rem] bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black uppercase tracking-[0.2em] text-[10px] hover:bg-amber-500 dark:hover:bg-amber-500 dark:hover:text-white transition-all duration-500 shadow-xl shadow-slate-900/10 active:scale-[0.98]"
            >
