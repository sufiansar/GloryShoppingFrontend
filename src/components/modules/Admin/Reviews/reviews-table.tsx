...
export function ReviewsTable({ initialData, pagination }: ReviewsTableProps) {
 ...
 <TableHead className="py-6 pl-8 text-sm font-medium text-slate-400">Customer</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Rating & Review</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Product</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Temporal Data</TableHead>
 <TableHead className="text-right py-6 pr-8 text-sm font-medium text-slate-400">Operations</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {reviews.length === 0 ? (
 ...
 <span className="text-sm font-medium text-slate-400">Empty Feedback Domain</span>
 ...
 <AvatarFallback className="bg-slate-100 dark:bg-slate-800 text-slate-400 font-medium">
 ...
 <span className="text-sm font-bold text-slate-400 er">
 {review.user.email}
 </span>
 </div>
 </div>
 ...
 <Badge className={`rounded-lg font-medium text-[8px] tracking-[0.1em] px-2 py-0.5 ${
...
"bg-slate-500/10 text-slate-600 border-slate-500/20"
 ...
 <span className="text-xs font-medium text-slate-700 dark:text-slate-300 truncate max-w-[150px] group-hover/product:text-primary-custom transition-colors">
 {review.product.name}
 </span>
