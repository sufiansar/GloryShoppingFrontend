...
export default function CategoryTable({
 ...
 <TableHead className="py-6 pl-8 text-sm font-medium text-slate-400">Name</TableHead>
 <TableHead className="py-6 text-sm font-medium text-slate-400">Description</TableHead>
 ...
 <span className="text-sm font-bold text-slate-400">Global Classification</span>
 </div>
 </TableCell>
 <TableCell>
