...
export function ShippingSettings() {
 ...
 <span className="text-sm font-medium tracking-[0.3em] text-slate-400">Synchronizing Logistics</span>
 <p className="text-xl font-medium text-slate-900 dark:text-white">Accessing Cloud Assets...</p>
 </div>
 </div>
 );
 }
 ...
 <span className="text-sm font-medium text-primary-custom">Security Level High</span>
 </div>
 <h1 className="text-4xl font-medium text-slate-900 dark:text-white leading-none">
 Shipping Matrix
 </h1>
 ...
 <span className="text-sm font-medium text-slate-400">Total Zones</span>
 <span className="text-2xl font-medium text-slate-900 dark:text-white">{configs.length}</span>
 </div>
 <Button 
 variant="outline"
 size="lg"
 onClick={fetchConfigs}
 className="rounded-[1.5rem] h-14 px-8 border-white/40 bg-white/40 dark:bg-slate-800/40 backdrop-blur-md hover:bg-white dark:hover:bg-slate-800 transition-all active:scale-95 font-medium text-sm"
 >
 Refetch Data
 </Button>
 </div>
 ...
 <p className="text-xl font-medium text-slate-400">Empty Logistics Domain</p>
 ...
 <Button 
 variant="outline"
 className="mt-4 rounded-2xl h-12 px-8 font-medium text-sm border-slate-200 dark:border-slate-800"
 onClick={fetchConfigs}
 >
 Initialize Defaults
 </Button>
...
function ShippingZoneCard({ config, isUpdating, onSave }: ShippingZoneCardProps) {
 ...
 <span className="text-sm font-medium text-slate-400 -mt-1 block">Geo Configuration</span>
 </div>
 </div>
 ...
 <FormItem>
 <div className="flex items-center justify-between mb-2">
 <FormLabel className="text-sm font-medium text-slate-400 flex items-center gap-2">
 ...
 disabled={isUpdating}
 className="pl-10 h-16 bg-white/60 dark:bg-slate-800/40 backdrop-blur-md border-primary/40 dark:border-primary/40 rounded-2xl shadow-inner focus-visible:ring-primary-custom/30 text-xl font-medium text-slate-900 dark:text-white transition-all duration-500"
 />
 </div>
 </FormControl>
 </FormItem>
 ...
 <FormDescription className="text-sm font-medium text-slate-400">
 ...
 className="w-full h-16 rounded-[1.5rem] bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-medium text-sm hover:bg-primary-custom dark:hover:bg-primary-custom dark:hover:text-white transition-all duration-500 shadow-xl shadow-slate-900/10 active:scale-[0.98]"
 >
 {isUpdating ? (
