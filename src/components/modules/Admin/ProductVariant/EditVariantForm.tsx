...
export default function EditVariantForm({ variant }: EditVariantFormProps) {
 ...
 <div>
 <h2 className="text-xl font-medium text-slate-900 dark:text-white">Parent Product</h2>
 <p className="text-sm font-medium text-slate-400 -mt-1">Read-Only Information</p>
 </div>
 </div>
 ...
 <h3 className="font-medium text-slate-900 dark:text-white">Product {variant.productId}</h3>
 ...
 <p className="text-[9px] font-medium text-emerald-600 dark:text-emerald-400">Base Price</p>
 <p className="text-lg font-medium text-emerald-700 dark:text-emerald-300">${variant.price?.toFixed(2) ||"0.00"}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div>
 <h2 className="text-xl font-medium text-slate-900 dark:text-white">Variant Configuration</h2>
 <p className="text-sm font-medium text-slate-400 -mt-1">Size & Inventory Settings</p>
 </div>
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="space-y-2">
 <Label htmlFor="sku"className="text-sm font-medium text-slate-400 ml-1">SKU</Label>
 <Input
 id="sku"
 value={variant.sku}
 disabled
 ...
 <div className="space-y-2">
 <Label htmlFor="size"className="text-sm font-medium text-slate-400 ml-1">Size *</Label>
 <Input
 id="size"
 name="size"
 value={formData.size}
 ...
 <div className="space-y-2">
 <Label htmlFor="stock"className="text-sm font-medium text-slate-400 ml-1">Stock Quantity</Label>
 <Input
 id="stock"
 name="stock"
 type="number"
 ...
 <div className="space-y-2">
 <Label htmlFor="lowStockThreshold"className="text-sm font-medium text-slate-400 ml-1">Low Stock Threshold</Label>
 <Input
 ...
 <div>
 <h2 className="text-xl font-medium text-slate-900 dark:text-white">Variant Media</h2>
 <p className="text-sm font-medium text-slate-400 -mt-1">Gallery & Assets</p>
 </div>
 </div>
 <span className="bg-white/80 dark:bg-slate-800 py-1.5 px-4 rounded-xl text-sm font-bold text-slate-500 shadow-sm border border-slate-200/50 dark:border-slate-700/50">
 ...
 <div>
 <p className="text-[13px] font-medium text-slate-600 dark:text-slate-300 mb-1 group-hover:text-primary-custom transition-colors">Click or drag images to upload</p>
 <p className="text-sm font-bold text-slate-400 opacity-80 er">
 ...
 className="rounded-2xl h-14 px-8 text-sm font-medium text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all active:scale-95"
 >
 Cancel
 </Button>
