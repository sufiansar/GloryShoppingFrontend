    ...
    return (
      <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 rounded-[2.5rem] p-16 text-center shadow-inner">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[14px] font-black uppercase tracking-widest text-slate-400">No variants found</p>
          <Button className="mt-4 rounded-2xl h-12 px-8 bg-primary-custom text-white font-black uppercase tracking-[0.2em] text-[10px] shadow-lg shadow-primary-custom/20 hover:shadow-primary-custom/40 transition-all border-none" asChild>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center bg-white/50 dark:bg-slate-800/40 p-1 rounded-2xl border border-white/50 dark:border-slate-700/50 shadow-sm backdrop-blur-md">
            <Button
              ...
              className={`rounded-xl h-10 px-4 text-[10px] font-black uppercase tracking-widest transition-all ${initialSortBy === "sku" ? "bg-white dark:bg-slate-700 shadow-sm text-primary-custom" : "text-slate-500 hover:text-slate-700"}`}
            >
              SKU{" "}
              {initialSortBy === "sku" &&
            ...
            <Button
              ...
              className={`rounded-xl h-10 px-4 text-[10px] font-black uppercase tracking-widest transition-all ${initialSortBy === "createdAt" ? "bg-white dark:bg-slate-700 shadow-sm text-primary-custom" : "text-slate-500 hover:text-slate-700"}`}
            >
              Date{" "}
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-white/20 dark:border-slate-800/30 hover:bg-transparent px-6 text-left">
                <TableHead className="py-6 pl-8 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">SKU</TableHead>
                <TableHead className="py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Product</TableHead>
                <TableHead className="py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Size</TableHead>
              ...
              {variants.map((variant) => (
                <TableRow key={variant.id} className="premium-table-row border-b border-slate-100/30 dark:border-slate-800/20 group/row">
                  <TableCell className="py-5 pl-8 font-medium">
                    <span className="text-xs font-black text-primary-custom bg-primary-custom/5 px-3 py-1.5 rounded-xl border border-primary-custom/10 w-fit inline-block tracking-widest">
                      {variant.sku}
                    </span>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <span className="font-black text-[10px] uppercase tracking-widest px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-300">
                      {variant.size}
                    </span>
                  </TableCell>
                  <TableCell>
