...
export default function AddProductsPage() {
 ...
 <Button variant="ghost"className="mb-2 rounded-2xl h-12 px-6 hover:bg-white/40 dark:hover:bg-slate-800/40 text-sm font-medium text-slate-600 dark:text-slate-300 transition-all">
 ...
 <CheckCircle2 className="mr-3 h-6 w-6 text-emerald-600 font-medium"/>
 ...
 <Label className="text-sm font-medium text-slate-500 ml-2">Skin Concern *</Label>
 <Select
 ...
 <div className="space-y-3">
 <Label className="text-sm font-medium text-slate-500 ml-2">Skin Type *</Label>
 <Select
 ...
 <Label className="text-sm font-medium text-primary-custom">Selected Products ({selectedProducts.length})</Label>
 <div className="flex flex-wrap gap-3">
 {getSelectedProducts().map((product) => (
 <Badge key={product.id} className="bg-white dark:bg-slate-800 hover:bg-white/80 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-200/50 dark:border-slate-700 px-4 py-2 rounded-xl text-sm font-medium shadow-sm transition-all group">
 {product.name}
 <button
 ...
 <Label className="text-sm font-medium text-slate-600 dark:text-slate-400">Select Products *</Label>
 ...
 <p className="mt-6 text-sm font-medium text-slate-400">Loading directory...</p>
 </div>
 ) : (
 <>
 ...
 {product.price && (
 <p className="mt-2 text-xs font-medium text-primary-custom bg-primary-custom/10 px-2.5 py-1 rounded-lg w-fit">
 ...
 <Button
 variant="outline"
 className="rounded-2xl h-12 px-8 border-slate-200/50 bg-white/40 dark:bg-slate-800/40 hover:bg-white text-sm font-medium shadow-sm transition-all"
 ...
 <Button
 className="w-full md:w-auto rounded-2xl h-14 px-10 bg-primary-custom text-white font-medium text-sm shadow-lg shadow-primary-custom/20 hover:shadow-primary-custom/40 transition-all border-none"
 disabled={
 loading ||
 !selectedSkinConcern ||
 !selectedSkinType ||
