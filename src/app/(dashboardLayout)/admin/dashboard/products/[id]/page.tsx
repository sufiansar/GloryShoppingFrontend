...
export default async function ProductDetailsPage({
 ...
 <div>
 <Button variant="ghost"size="sm"asChild className="mb-4 rounded-xl px-4 text-sm font-medium text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all active:scale-95 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700">
 ...
 <Button asChild className="rounded-2xl h-12 px-8 bg-primary-custom text-white font-medium text-sm shadow-lg shadow-primary-custom/20 hover:shadow-primary-custom/40 transition-all active:scale-95 border-none">
